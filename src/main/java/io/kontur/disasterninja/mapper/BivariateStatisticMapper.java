...
public interface BivariateStatisticMapper {
    ...
    @Mapping(target = "unit", expression = "java(bivariateLayerLegendQueryUnitToUnitDto(quotient.unit()))")
    ...
    UnitDto bivariateLayerLegendQueryUnitToUnitDto(BivariateLayerLegendQuery.Unit unit);
    ...
    @Mapping(target = "unit", expression = "java(BivariateLayerLegendQueryUnit1ToUnitDto(quotient1.unit()))")
    ...
    UnitDto BivariateLayerLegendQueryUnit1ToUnitDto(BivariateLayerLegendQuery.Unit1 unit1);
    ...
    @Mapping(target = "unit", expression = "java(BivariateLayerLegendQueryUnit2ToUnitDto(indicator.unit()))")
    ...
    UnitDto BivariateLayerLegendQueryUnit2ToUnitDto(BivariateLayerLegendQuery.Unit2 unit2);
    ...
    @Mapping(target = "copyrights", expression = "java(indicator.copyrights())")
    @Mapping(target = "direction", expression = "java(indicator.direction())")
    @Mapping(target = "unit", expression = "java(bivariateMatrixQueryUnit1ToUnitDto(indicator.unit()))")
    IndicatorDto bivariateMatrixQueryIndicatorToIndicatorDto(BivariateMatrixQuery.Indicator indicator);

    @Mapping(target = "id", expression = "java(unit1.id())")
    @Mapping(target = "shortName", expression = "java(unit1.shortName())")
    @Mapping(target = "longName", expression = "java(unit1.longName())")
    UnitDto bivariateMatrixQueryUnit1ToUnitDto(BivariateMatrixQuery.Unit1 unit1);
    ...
    @Mapping(target = "label", expression = "java(quotient.label())")
    @Mapping(target = "direction", expression = "java(quotient.direction())")
    @Mapping(target = "unit", expression = "java(bivariateMatrixQueryUnitToUnitDto(quotient.unit()))")
    BivariateLegendQuotient bivariateMatrixQueryQuotientToBivariateLegendQuotient(BivariateMatrixQuery.Quotient quotient);

    @Mapping(target = "id", expression = "java(unit.id())")
    @Mapping(target = "shortName", expression = "java(unit.shortName())")
    @Mapping(target = "longName", expression = "java(unit.longName())")
    UnitDto bivariateMatrixQueryUnitToUnitDto(BivariateMatrixQuery.Unit unit);
