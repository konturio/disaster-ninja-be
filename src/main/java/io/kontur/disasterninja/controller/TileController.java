...
public class TileController {
    ...
    @Operation(summary = "Returns bivariate mvt tile using z, x, y and Insights API service",
            tags = {"Tiles"},
            description = "Returns bivariate mvt tile using z, x, y and Insights API service")
