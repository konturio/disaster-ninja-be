...
public class BivariateMatrixController {
    ...
    @ApiResponse(responseCode = "200", description = "Successful operation",
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = BivariateStatisticDto.class)))
    @PostMapping
    @PreAuthorize("hasRole('bivariateStatistic')")
    public BivariateStatisticDto getBivariateMatrix(
