...
public final class TestUtil {
    ...
    public static Legend createLegend() {
        ...
        axes.setX(new BivariateLegendAxisDescription("xLabel", null, null, null, null, null));
        axes.setY(new BivariateLegendAxisDescription("yLabel", null, null, null, null, null));
